...
class MCPClient:
    ...
    def search_jira_issues(
        ...
        resp = self.call_tool("jira_search", args)
        if resp.isError:
            ...
            if item.get("type") == "text":
                try:
                    ...
                    if isinstance(data, list):
                        ...
                        # Handle both direct issue objects and search results with 'issues' field
                        if "issues" in data:
            ...
            if item.get("type") == "text":
                try:
                    ...
                    if isinstance(data, list):
                        ...
                        # Handle both direct page objects and search results with 'results' field
                        if "results" in data:
                            for page_data in data["results"]:
                                pages.append(ConfluencePage(**page_data))
                        else:
